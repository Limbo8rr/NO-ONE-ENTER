...
sprites.onOverlap(SpriteKind.P2, SpriteKind.Boogie_Board, function (sprite, otherSprite) {
    if (sprite.x < otherSprite.x) {
        otherSprite.setVelocity(randint(15, 45), 50)
...
game.showLongText("Hazel rates this game 3.2/10                         i rate it it isn't really much though thats why score so low", DialogLayout.Full)
BeatHighScore = false
Pause = true
info.setScore(0)
RunSpeed = -65
